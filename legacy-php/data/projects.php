...
return [
    ...
    'aurum-retail' => [
        ...
        'challenge'   => 'Aurum was scaling fast but their off-the-shelf theme couldn’t keep up — slow product pages, a clunky checkout, and no room for the editorial storytelling the brand is known for.',
        'solution'    => 'We rebuilt the store on Shopify Plus with a custom theme, a streamlined one-page checkout, dynamic lookbooks, and app integrations for loyalty and reviews — all tuned for speed and conversion.',
        'results'     => [
        ...
        'hero'        => '/assets/work/aurum-retail/hero.webp',
        'gallery'     => [
            '/assets/work/aurum-retail/01.webp',
            '/assets/work/aurum-retail/02.webp',
        ],
        'accent'      => '#e7c65b',
    ...
    'kesar-foods' => [
        ...
        'challenge'   => 'Kesar Foods had loyal offline customers but no way to sell their saffron and spice range online — and they wanted full ownership of the platform, not a locked-in SaaS.',
        'solution'    => 'We built a fast, content-rich WooCommerce store on WordPress: recipe-led product storytelling, subscription boxes, multiple payment gateways, and inventory synced to their warehouse — all owned outright by the brand.',
        'results'     => [
        ...
        'hero'        => '/assets/work/kesar-foods/hero.webp',
        'gallery'     => [
            '/assets/work/kesar-foods/01.webp',
            '/assets/work/kesar-foods/02.webp',
        ],
        'accent'      => '#ff7a4d',
    ...
    'nova-labs' => [
        ...
        'challenge'   => 'Nova Labs was launching premium hardware and wanted a storefront that felt as advanced as their products — instant, app-like, and free of the constraints of a templated platform.',
        'solution'    => 'We built a headless store: a Next.js/React storefront on the front, commerce APIs and a headless CMS behind it, and a custom checkout. The result loads instantly, ranks well, and gives the team total design freedom.',
        'results'     => [
        ...
        'hero'        => '/assets/work/nova-labs/hero.webp',
        'gallery'     => [
            '/assets/work/nova-labs/01.webp',
            '/assets/work/nova-labs/02.webp',
        ],
        'accent'      => '#5cffce',
